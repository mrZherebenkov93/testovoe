...
function register_post_types(){
	register_post_type( 'nedvizhimost', [
		'label'  => null,
		'labels' => [
			'name'               => 'Недвижимость', // основное название для типа записи
			'singular_name'      => 'Обьект', // название для одной записи этого типа
			'add_new'            => 'Добавить Обьект', // для добавления новой записи
			'add_new_item'       => 'Добавление Обьекта', // заголовка у вновь создаваемой записи в админ-панели.
			'edit_item'          => 'Редактирование Обьекта', // для редактирования типа записи
			'new_item'           => 'Новый Обьект', // текст новой записи
			'view_item'          => 'Смотреть Обьект', // для просмотра записи этого типа.
			'search_items'       => 'Искать Обьект', // для поиска по этим типам записи
